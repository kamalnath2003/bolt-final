...
def visualize():
    ...
    ax.figure.canvas.set_window_title('Bolt Stock Visualizer ')
...
# Define Main Window
root = Tk()
root.title("Bolt Stock Visualizer")
...
label_ticker = Label(root, text="Company Ticker:")
label_ticker.pack()
text_ticker = Entry(root)
text_ticker.pack()

btn_visualize = Button(root, text="Plot graph", command=visualize)
btn_visualize.pack()
